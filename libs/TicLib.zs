...
function isBoomTool(itemStack as IItemStack) as bool {
        
        var pass as bool = false;
        var boomtool as IItemStack[] = [
            <tinkersarsenal:boomstick>,
            <tinkersarsenal:boomstick_shot>
        ];
...
function isGeatersword(itemStack as IItemStack) as bool {
        
        var pass as bool = false;
        var greatsword as IItemStack[] = [
            <tinkers_reforged:greatsword>
        ];
...
function isKhopesh(itemStack as IItemStack) as bool {
        
        var pass as bool = false;
        var khopesh as IItemStack[] = [
            <tinkers_reforged:khopesh>
        ];
...
function isGladius(itemStack as IItemStack) as bool {
        
        var pass as bool = false;
        var gladius as IItemStack[] = [
            <tinkers_reforged:gladius>
        ];
...
function isGreatsword(itemStack as IItemStack) as bool {
...
function isScythe(itemStack as IItemStack) as bool {
        
        var pass as bool = false;
        var scythe as IItemStack[] = [
            <tconstruct:scythe>
        ];
