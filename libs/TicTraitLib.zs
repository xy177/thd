...
zenClass ticTraitLib {
    ...
    function addTicTraitex(itemStack as IItemStack, traitid as string, traitcolor as int, traitlevel as int) as bool{
        var pass as bool = false;
        ...
        itemStack.mutable().updateTag({Modifiers : modifiers.deepUpdate(addmodifier, APPEND), Traits : traits.deepUpdate(addtrait, APPEND), TinkerData : {Modifiers : tinkerData.deepUpdate(addtrait, APPEND)}});
    return true;
    }
